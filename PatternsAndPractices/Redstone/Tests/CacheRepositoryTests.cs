namespace Interview
{
    ...
    public class CacheRepositoryTests
    {
        ...
        {
            var cleanCache = new List<Storeable>();

            this.repo = new CacheRepository<Storeable>(cleanCache);
        }
